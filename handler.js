...
global.dfail = (type, m, conn) => {
    ...
    let pp = 'https://telegra.ph/file/ca9ee903d5b4d5e35a490.jpg'
    let msg = {
    ...
    unreg: conn.sendButtonImg(m.chat, await(await fetch(pp)).buffer(), teks, foot, 'V e r i f y', '.verify', m.text, m)
  }[type]

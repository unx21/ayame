...
global.dfail = (type, m, conn) => {
    ...
    let foto = 'https://telegra.ph/file/ca9ee903d5b4d5e35a490.jpg'
    let msg = {
    ...
    unreg: await conn.sendButtonImg(m.chat, await(await fetch(foto)).buffer(), teks, foot, 'V e r i f y', '.verify', m.text, m)
  }[type]
